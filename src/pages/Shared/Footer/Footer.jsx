...
const Footer = () => {
  ...
  <div>
    ...
    <p>Glaze Car Ltd.<br/>Providing reliable toys since 1992</p>
  </div> 
  <div>
    <span className="footer-title">Contact</span> 
    <a className="link link-hover">+0284-435462</a> 
    <a className="link link-hover">info@gmail.com</a> 
    <Link to="https://www.linkedin.com/" className="link link-hover">LinkedIn</Link> 
    <a className="link link-hover">What's app</a>
  </div> 
  <div>
